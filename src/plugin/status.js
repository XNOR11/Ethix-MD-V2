...
const handleGreeting = async (m, gss) => {
  try {
    ...
    const triggerWords = ["send", "share", "snd", "ewhan", "save", "ewana", "share", "ewanawako", "dpn", "save", "one", "danna", "dannako", "ewanna", "ewannako", "ewpn", "dapan", "danna","send", "share", "snd", "ewhan", "save", "ewana", "share", "ewanawako", "dpn", "save", "one", "danna", "dannako", "ewanna", "ewannako", "ewpn", "dapan", "danna", "oni"];
